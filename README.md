# ArmorSkinFixed [![HitCount](http://hits.dwyl.com/Nunny26/ArmorSkinFixed.svg?style=flat)](http://hits.dwyl.com/Nunny26/ArmorSkinFixed) [![master](https://github.com/Nunny26/ArmorSkinFixed/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/Nunny26/ArmorSkinFixed/actions/workflows/build.yml) ![Downloads](https://img.shields.io/github/downloads/Nunny26/ArmorSkinFixed/Total) ![Commits](https://img.shields.io/github/commit-activity/m/Nunny26/ArmorSkinFixed)
Minecraft fabric mod that shows armor types in the armor status bar.

<a href='https://ko-fi.com/nunny26' target='_blank'><img height='36' style='border:0px;height:36px;' src='https://cdn.ko-fi.com/cdn/kofi2.png?v=3' border='0' alt='Buy Me a Coffee at ko-fi.com' /></a>
